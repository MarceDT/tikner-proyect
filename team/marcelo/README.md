...
1. `starter-kit/apps/web/src/lib/incidents.ts` -> Renombrar/reemplazar con los datos del nuevo dominio (ej. `patients.ts`, `disputes.ts`, `properties.ts`).
2. `starter-kit/apps/web/src/components/workplace-followups.tsx` (o componente de aprobación): Diseñar el modal/tarjeta de confirmación previa a cualquier acción crítica.
3. `starter-kit/SUBMISSION.md`: Completar el formulario de entrega oficial del hackathon.
